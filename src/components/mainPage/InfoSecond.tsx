    ...
    <div className="row align-items-center">
      ...
      <div className="col-md-6 info__wrapper-info ">
        ...
        <p className="text-sm-gray mb-5 mt-3">
          More than ten thousand houses at your disposal.Only the best
          and checked landlords.We will find best place for you and
          the conditions for a safe transaction and comfortable stay.
        </p>
